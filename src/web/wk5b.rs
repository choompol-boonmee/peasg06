...
fn rp(wk5prc: &wk5::Wk5Proc) -> &Repo1 {
    &wk5prc.wk5b
}
fn sp(wk5prc: &mut wk5::Wk5Proc, rp: Repo1) {
    wk5prc.wk5b = rp;
}
...
pub async fn handler() -> Wk5b {
    Wk5b::new(base().wk5prc.clone()).await
}
