...
impl ReportTemp {
    ...
    async fn new(wk5prc: Arc<RwLock<wk5::Wk5Proc>>) -> Self {
        ...
        let title = "FINANCIAL BENEFIT NPV PROJECTION : WK5T";
...
const TT: [&str; 4] = ["NO", "PROV", "FDID", "SUM"];
...
impl Report {
    pub fn dava(&self, ssv: &Vec<wk5::Substation>, r: usize, c: usize) -> dcl::DaVa {
        ...
        match c {
            ...
            3 => DaVa::F32(fd.financial_benefit_npv),
            // ========
            n => DaVa::F32(fd.financial_benefit_npv_series[n - 4]),
        }
    }
}
