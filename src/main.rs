...
async fn main() {
    ...
    match ath.as_str() {
        ...
        "P33" => crate::sg::prc3::prc33().await.expect("?"), // trans,meter,energy
        "P34" => crate::sg::prc3::prc34().await.expect("?"), // load profile
        "P35" => crate::sg::prc3::prc35().await.expect("?"), // load profile pv-sb-fd
        "P37" => crate::sg::prc3::prc37().await.expect("?"), // load switch file
        "P38" => crate::sg::prc3::prc38().await.expect("?"), // load switch file
        "P39" => crate::sg::prc3::prc39().await.expect("?"), // load switch file

        "P41" => crate::sg::prc4::prc41().await.expect("?"), // load switch file
        "P42" => crate::sg::prc4::prc42().await.expect("?"), // load switch file
        "P43" => crate::sg::prc4::prc43().await.expect("?"), // load switch file
        "P44" => crate::sg::prc4::prc44().await.expect("?"), // load switch file
        "P45" => crate::sg::prc4::prc45().await.expect("?"), // load switch file
        "P46" => crate::sg::prc4::prc46().await.expect("?"), // load switch file

        "P51" => crate::sg::prc5::prc51().await.expect("?"), // load switch file
        "P52" => crate::sg::prc5::prc52().await.expect("?"), // load switch file
        "P53" => crate::sg::prc5::prc53().await.expect("?"), // load switch file
        "P54" => crate::sg::prc5::prc54().await.expect("?"), // load switch file
