...
impl ReportTemp {
    ...
    async fn new(wk5prc: Arc<RwLock<wk5::Wk5Proc>>) -> Self {
        ...
        let title = "EV Distribution : WK5F";
    ...
    pub fn sum(&self, c: &usize) -> String {
        ...
        match rp(&self.wk).sums[*c] {
            ...
            DaVa::F64(v) => ((v * 100.0).floor() / 100.0).separate_with_commas(),
            DaVa::USZ(v) => v.separate_with_commas(),
            DaVa::I32(v) => v.separate_with_commas(),
            DaVa::I64(v) => v.separate_with_commas(),
            _ => format!(""),
        }
    }
...
pub async fn make_repo(wk5prc: &mut wk5::Wk5Proc, acfg: Arc<RwLock<dcl::Config>>) {
    ...
    let tt = [
        "NO", "SSID", "NAME", "PROV", "FDID", "EV", "TX", "M1", "M3", "ENERGY",
    ];
    for t in tt {
...
impl Report {
    pub fn dava(&self, ssv: &Vec<wk5::Substation>, r: usize, c: usize) -> dcl::DaVa {
        ...
        match c {
            ...
            5 => DaVa::F32(fd.ev.ev_ds),
            6 => DaVa::USZ(fd.tx.tx_no),
            7 => DaVa::USZ(fd.tx.mt1_no),
            8 => DaVa::USZ(fd.tx.mt3_no),
            9 => DaVa::F32(fd.year_load.power_quality.pos_energy),
            //8 => DaVa::F32(222.0),
            n => DaVa::USZ(n),
        }
    }
