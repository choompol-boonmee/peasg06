...
impl Report {
    pub fn dava(&self, ssv: &Vec<wk5::Substation>, r: usize, c: usize) -> dcl::DaVa {
        ...
        match c {
            ...
            4 => DaVa::F32(fd.year_load.power_quality.pos_peak),
            5 => DaVa::F32(fd.year_load.power_quality.pos_avg),
            6 => DaVa::F32(fd.year_load.power_quality.pos_energy),
            7 => DaVa::F32(fd.year_load.power_quality.neg_energy),
            // ========
            n => DaVa::USZ(n),
        }
    }
