...
const TT: [&str; 15] = [
    "NO", "PROV", "SSID", "SSNAME", "FDID", "FDID", "DTX", "M1P", "M3P", "COST", "FR", "ER",
    "FIRR", "EIRR", "ENERGY",
];
...
impl Report {
    pub fn dava(&self, ssv: &Vec<wk5::Substation>, r: usize, c: usize) -> dcl::DaVa {
        ...
        match c {
            ...
            5 => DaVa::Text(fd.fdid.to_string()),
            6 => DaVa::USZ(fd.tx.tx_no),
            7 => DaVa::USZ(fd.tx.mt1_no),
            8 => DaVa::USZ(fd.tx.mt3_no),
            9 => DaVa::F32(fd.total_cost_npv),
            10 => DaVa::F32(fd.financial_benefit_npv),
            11 => DaVa::F32(fd.economic_benefit_npv),
            12 => DaVa::F32(fd.firr * 100.0),
            13 => DaVa::F32(fd.eirr * 100.0),
            14 => DaVa::F32(fd.year_load.power_quality.pos_energy),
            n => DaVa::USZ(n),
        }
    }
}
